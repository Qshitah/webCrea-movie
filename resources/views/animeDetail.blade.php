        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-8 mb-40">
                        ...
                        <div class="text-block">
                            ...
                            <div class="mb-24">
                                <div class="botton-row">
                                    ...
                                    <div class="btn-block">
                                        <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply2" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                    </div>
                                </div>
                            ...
                            <a href="#" class="accordion-button comment-btn collapsed  mb-32 action-btn" data-bs-toggle="collapse" data-bs-target="#reply" aria-expanded="false" aria-controls="reply"><i class="fa fa-chevron-down"></i> Show 02 Replies</a>
                                        ...
                                        <div class="text-block">
                                            ...
                                            <div class="mb-24">
                                                <div class="botton-row">
                                                    ...
                                                    <div class="btn-block">
                                                        <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply3" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-block">
                                            ...
                                            <div class="mb-24">
                                                <div class="botton-row">
                                                    ...
                                                    <div class="btn-block">
                                                        <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply4" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                                    </div>
                                                </div>
                        ...
                        <div class="text-block">
                            ...
                            <div class="mb-24">
                                <div class="botton-row">
                                    ...
                                    <div class="btn-block">
                                        <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply5" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                    </div>
                                </div>
                                        ...
                                        <div class="text-block">
                                            ...
                                            <div class="mb-24">
                                                <div class="botton-row">
                                                    ...
                                                    <div class="btn-block">
                                                        <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply7" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-block">
                                            ...
                                            <div class="mb-24">
                                                <div class="botton-row">
                                                    ...
                                                    <div class="btn-block">
                                                        <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply8" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                                    </div>
                                                </div>
                        ...
                        <div class="text-block">
                            ...
                            <div class="mb-24">
                                <div class="botton-row">
                                    ...
                                    <div class="btn-block">
                                        <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply9" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                    </div>
                                </div>
                    ...
                    <div class="more">
                        <a href="#" class="accordion-button comment-btn collapsed  mb-0 action-btn" data-bs-toggle="collapse" data-bs-target="#reply20" aria-expanded="false" aria-controls="reply"> Load More Comments <i class="fa fa-chevron-down"></i>
                        </a>
                                ...
                                <div class="text-block">
                                    ...
                                    <div class="mb-24">
                                        <div class="botton-row">
                                            ...
                                            <div class="btn-block">
                                                <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply10" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                            </div>
                                        </div>
                                ...
                                <div class="text-block">
                                    ...
                                    <div class="mb-0">
                                        <div class="botton-row">
                                            ...
                                            <div class="btn-block">
                                                <button class=" accordion-button collapsed comment-btn reply-btn" data-bs-toggle="collapse" data-bs-target="#reply11" aria-expanded="true">Reply <i class="fal fa-reply"></i></button>
                                            </div>
                                        </div>
