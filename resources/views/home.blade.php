...
@section('content')
    ...
    <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xxl-4 col-lg-6">
                        <div class="item mb-40">
                            <img src="{{asset('/media/anime-card/img-7.png')}}" alt="">
                            <div class="content">
                    ...
                    <div class="col-xxl-4 col-lg-6">
                        <div class="item mb-40">
                            <img src="{{asset('/media/anime-card/img-11.png')}}" alt="">
                            <div class="content">
        ...
        <section class="comming-soon p-40">
            <div class="container-fluid">
                <div class="content">
                    <img src="{{asset('/media/comming-soon/image.png')}}" alt="">
                    <div class="details">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 mb-xl-0 mb-30">
                        <div class="anime-card">
                            <img src="{{asset('/media/anime-card/img-13.png')}}" class="br-20" alt="">
                            <div class="name">
                        ...
                        <div class="row">
                            <div class="col-xxl-12">
                                <div class="anime-card st-2 mb-30">
                                    <img src="{{asset('/media/anime-card/img-14.png')}}" alt="">
                                    <div class="name">
                                    ...
                                    <div class="btn-block">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#videoModal" class="cus-btn-2">
                            ...
                            <div class="col-xxl-12">
                                <div class="anime-card st-2">
                                    <img src="{{asset('/media/anime-card/img-15.png')}}" alt="">
                                    <div class="name">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-6">
                                <div class="anime-card st-2 mb-30 mb-none">
                                    <img src="{{asset('/media/anime-card/img-16.png')}}" alt="">
                                    <div class="name">
                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="anime-card st-2">
                                    <img src="{{asset('/media/anime-card/img-17.png')}}" alt="">
                                    <div class="name">
