                ...
                <div class="row">
                    <div class="col-xxl-12 col-xl-4">
                        <div class="filter mb-32">
                            ...
                            <a href="{{url('/listing')}}" class="cus-btn primary mb-50">
                                Filter
                        ...
                        <div class="top-anime mb-12">
                            ...
                            <div class="row">
                                <div class="col-xxl-12 col-md-6">
                                    <a href="{{url('/movie-detail')}}" class="anime-card mb-12">
                                        <img src="/media/anime-card/img-27.png" alt="">
                                ...
                                <div class="col-xxl-12 col-md-6">
                                    <a href="{{url('/movie-detail')}}" class="anime-card mb-12">
                                        <img src="/media/anime-card/img-28.png" alt="">
                                        <div class="text-block">
                                            <div class="sm-title">
                                                <h6 class="color-white">The Daily Life of the Immortal King</h6>
                                                <p class="color-medium-gray sm sec">Season 3</p>
                                ...
                                <div class="col-xxl-12 col-md-6">
                                    <a href="{{url('/movie-detail')}}" class="anime-card mb-12">
                                        <img src="/media/anime-card/img-29.png" alt="">
                                        <div class="text-block">
                                            <div class="sm-title">
                                                <h6 class="color-white">The Daily Life of the Immortal King</h6>
                                                <p class="color-medium-gray sm sec">Season 3</p>
                                ...
                                <div class="col-xxl-12 col-md-6">
                                    <a href="{{url('/movie-detail')}}" class="anime-card mb-12">
                                        <img src="/media/anime-card/img-30.png" alt="">
                                        <div class="text-block">
                                            <div class="sm-title">
                                                <h6 class="color-white">The Daily Life of the Immortal King</h6>
                                                <p class="color-medium-gray sm sec">Season 3</p>
            ...
            <div class="col-xxl-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 mb-40">
                        <div class="card st-2 m-0">
                            <div class="img-block mb-20">
                                <img src="/media/anime-card/img-23.png" alt="">
                                <a href="{{url('/movie-detail')}}" class="cus-btn light">
                                    Stream Now
                                    <i class="far fa-play"></i>
                                </a>
                    ...
                    <div class="col-md-4 col-sm-6 mb-40">
                        <div class="card st-2 m-0">
                            <div class="img-block mb-20">
                                <img src="/media/anime-card/img-24.png" alt="">
                                <a href="{{url('/movie-detail')}}" class="cus-btn light">
                                    Stream Now
                                    <i class="far fa-play"></i>
                                </a>
                    ...
                    <div class="col-md-4 col-sm-6 mb-40">
                        <div class="card st-2 m-0">
                            <div class="img-block mb-20">
                                <img src="/media/anime-card/img-25.png" alt="">
                                <a href="{{url('/movie-detail')}}" class="cus-btn light">
                                    Stream Now
                                    <i class="far fa-play"></i>
                                </a>
                    ...
                    <div class="col-md-4 col-sm-6 mb-40">
                        <div class="card st-2 m-0">
                            <div class="img-block mb-20">
                                <img src="/media/anime-card/img-4.png" alt="">
                                <a href="{{url('/movie-detail')}}" class="cus-btn light">
                                    Stream Now
                                    <i class="far fa-play"></i>
                                </a>
                    ...
                    <div class="col-md-4 col-sm-6 mb-40">
                        <div class="card st-2 m-0">
                            <div class="img-block mb-20">
                                <img src="/media/anime-card/img-5.png" alt="">
                                <a href="{{url('/movie-detail')}}" class="cus-btn light">
                                    Stream Now
                                    <i class="far fa-play"></i>
                                </a>
                    ...
                    <div class="col-md-4 col-sm-6 mb-40">
                        <div class="card st-2 m-0">
                            <div class="img-block mb-20">
                                <img src="/media/anime-card/img-6.png" alt="">
                                <a href="{{url('/movie-detail')}}" class="cus-btn light">
                                    Stream Now
                                    <i class="far fa-play"></i>
                                </a>
